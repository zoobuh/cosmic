(() => {
  var e = {
        ...
        function n(e, n) {
          var s,
            ...
            c =
              ...
              (i = ''),
              (a = ''),
              (o = s.split('=')).length > 1 ? ((i = o.shift()), (a = o.join('='))) : (a = s),
              { name: i, value: a }),
            u = c.name,
            d = c.value;
        ...
        function n(e, t) {
          e.Trap('Element.prototype.attributes', {
                ...
                r = new Proxy(t, {
                  get(e, n, s) {
                    ...
                    return 'length' === n
                      ...
                      ? new Proxy(i, {
                          apply: (e, n, s) =>
                            n === r ? Reflect.apply(e, t, s) : Reflect.apply(e, n, s),
                        })
                      : ('string' != typeof n && 'number' != typeof n) || isNaN(Number(n))
                      ? this.has(e, n)
                        ? i
                        : void 0
                      : t[Object.keys(r)[n]];
                  ...
                  has: (e, r) =>
                    'symbol' == typeof r
                      ? Reflect.has(e, r)
                      : !(
                          r.startsWith('scramjet-attr-') || t[r]?.name?.startsWith('scramjet-attr-')
                        ) && Reflect.has(e, r),
                });
              return r;
            },
            ...
            e.Trap(['Attr.prototype.value', 'Attr.prototype.nodeValue'], {
              get: (e) =>
                e.this?.ownerElement ? e.this.ownerElement.getAttribute(e.this.name) : e.get(),
              set: (e, t) =>
                e.this?.ownerElement ? e.this.ownerElement.setAttribute(e.this.name, t) : e.set(t),
            });
        }
        ...
        function n(e, t) {
          e.serviceWorker.addEventListener('message', ({ data: t }) => {
            if ('scramjet$type' in t && 'cookie' === t.scramjet$type) {
              ...
              let r = { scramjet$token: t.scramjet$token, scramjet$type: 'cookie' };
                ...
                return new Proxy(r, {
                  get(e, t) {
                    ...
                    return 'function' == typeof s
                      ? new Proxy(s, { apply: (e, t, n) => Reflect.apply(e, r, n) })
                  ...
                  set: (t, r, s) =>
                    'cssText' == r || '' == s || 'string' != typeof s
                      ? Reflect.set(t, r, s)
                      : Reflect.set(t, r, (0, n.U)(s, e.meta)),
                });
              },
              set(e, t) {
                e.set(t);
      ...
      2439: function (e, t, r) {
        ...
        function h(e, t) {
          let r = {
            ...
            p = [
              (0, u.nativeGetOwnPropertyDescriptor)(t.HTMLAnchorElement.prototype, 'href'),
              (0, u.nativeGetOwnPropertyDescriptor)(t.HTMLAreaElement.prototype, 'href'),
            ];
          for (let e of Object.keys(r))
            for (let t of r[e]) {
              ...
              Object.defineProperty(t.prototype, e, {
                get() {
                  return ['src', 'data', 'href', 'action', 'formaction'].includes(e)
                    ? (0, o.Sd)(r.get.call(this))
                    : r.get.call(this);
                },
                set(t) {
          ...
          e.Trap('Node.prototype.baseURI', {
            ...
            e.Proxy('Element.prototype.getAttribute', {
              apply(t) {
                ...
                if (
                  e.natives.call('Element.prototype.hasAttribute', t.this, `scramjet-attr-${r}`)
                ) {
                ...
                let [r, s] = t.args,
                  i = n.G.find((e) => {
                    ...
                    return (
                      !!n &&
                      ('*' === n ||
                        ('function' != typeof n && n.includes(t.this.tagName.toLowerCase())))
                    );
                  });
                if (i) {
                  ...
                  (t.args[1] = n), t.fn.call(t.this, `scramjet-attr-${t.args[0]}`, s);
                }
              },
            }),
                ...
                let [r, s, i] = t.args,
                  a = n.G.find((e) => {
                    ...
                    return (
                      !!r &&
                      ('*' === r ||
                        ('function' != typeof r && r.includes(t.this.tagName.toLowerCase())))
                    );
                  });
                a &&
                  ((t.args[2] = a.fn(i, e.meta, e.cookieStore)),
                  e.natives.call(
            ...
            e.Proxy('Element.prototype.removeAttribute', {
              apply(t) {
                ...
                e.natives.call('Element.prototype.hasAttribute', t.this, t.args[0]) &&
            ...
            e.Trap('Element.prototype.innerHTML', {
              set(r, n) {
                ...
                if (r.this instanceof t.HTMLScriptElement)
                  (o = (0, a.Z)(n, '(anonymous script element)', e.meta)),
                    e.natives.call(
                      'Element.prototype.setAttribute',
                      r.this,
                      'scramjet-attr-script-source-src',
                      btoa(Array.from(d.encode(o), (e) => String.fromCodePoint(e)).join('')),
                    );
      ...
      461: function (e, t, r) {
        ...
        function i(e, t) {
          e.Proxy('History.prototype.pushState', {
            apply(t) {
              (t.args[2] || '' === t.args[2]) && (t.args[2] = (0, n.dm)(t.args[2], e.meta)),
                t.call();
      ...
      8805: function (e, t, r) {
        ...
        function a(e) {
          e.Proxy('window.open', {
            apply(t) {
              t.args[0] && (t.args[0] = (0, i.dm)(t.args[0], e.meta)),
              ...
              if (s.a3 in r) return t.return(r[s.a3].global);
              {
            ...
            e.Trap('window.frameElement', {
              get(e) {
                let t = e.get();
                return t ? (t.ownerDocument.defaultView[s.a3] ? t : null) : t;
              },
            });
        }
      },
      3261: function (e, t, r) {
        function n(e, t) {
          e.Trap('origin', { get: () => e.url.origin, set: () => !1 }),
            e.Trap('Document.prototype.URL', { get: () => e.url.href, set: () => !1 }),
            e.Trap('Document.prototype.documentURI', { get: () => e.url.href, set: () => !1 }),
            e.Trap('Document.prototype.domain', { get: () => e.url.hostname, set: () => !1 });
        }
        r.r(t), r.d(t, { default: () => n });
      },
      4475: function (e, t, r) {
        ...
        var n = r(2434);
        function s(e, t) {
          e.Trap('PerformanceEntry.prototype.name', { get: (e) => (0, n.Sd)(e.get()) });
        }
      },
      6101: function (e, t, r) {
        r.r(t), r.d(t, { default: () => s });
      ...
      5707: function (e, t, r) {
        r.r(t), r.d(t, { default: () => l, disabled: () => o, enabled: () => a, order: () => i });
        var n = r(7097),
          s = r(2434);
        let i = 2,
            ...
            e.Proxy('ServiceWorkerContainer.prototype.register', {
              apply(t) {
                ...
                e.natives.call(
                  ...
                  l,
                  { scramjet$type: 'registerServiceWorker', port: a, origin: e.url.origin },
                  [a],
                ),
                  r.set(n, o),
          ...
          let r = {
            ...
            ownKeys: (t) =>
              Reflect.ownKeys(t)
                ...
                .map((t) => ('string' == typeof t ? t.substring(e.url.host.length + 1) : t)),
        ...
        class f {
          ...
          constructor(e) {
            ...
            p.iswindow
              ...
              p.iswindow && (e.document[n.a3] = this),
              (this.locationProxy = (0, i.createLocationProxy)(this, e)),
              (this.wrapfn = (0, l.createWrapFn)(this, e)),
              (this.sourcemaps = {}),
              (this.natives = {
                store: new Proxy(
                  {},
            ...
            for (let r of e.keys()) {
              ...
              r.endsWith('.ts') &&
                ((r.startsWith('./dom/') && 'window' in this.global) ||
                  (r.startsWith('./worker/') && 'WorkerGlobalScope' in this.global) ||
                  r.startsWith('./shared/')) &&
                t.push(n);
            }
            for (let e of (t.sort((e, t) => (e.order || 0) - (t.order || 0)), t))
          ...
          set url(e) {
            ...
            this.frame && this.frame.dispatchEvent(t),
              t.defaultPrevented || (this.global.location.href = (0, u.dm)(t.url, this.meta));
          }
          Proxy(e, t) {
            if (Array.isArray(e)) {
              ...
              r.apply &&
                (i.apply = function (e, t, n) {
                  ...
                  Error.prepareStackTrace = function (e, t) {
                    if (
                      t[0].getFileName() &&
                      !t[0].getFileName().startsWith(location.origin + d.vc.prefix)
                    )
                  ...
                  return ((Error.prepareStackTrace = o), i)
                    ? s
                    : Reflect.apply(a.fn, a.this, a.args);
                }),
      ...
      8971: function (e, t, r) {
        ...
        function o(e, t) {
          ...
          for (let r of [
            ...
            if (!i) continue;
            let a = { configurable: !0, enumerable: !0 };
            i.get && (a.get = new Proxy(i.get, { apply: () => e.url[r] })),
              i.set &&
                (a.set = new Proxy(i.set, {
                  apply(n, i, a) {
                    if ('href' === r) {
                      e.url = a[0];
                      return;
          ...
          return (
            (o.toString = new Proxy(t.location.toString, { apply: () => e.url.href })),
            t.location.valueOf &&
              (o.valueOf = new Proxy(t.location.valueOf, { apply: () => e.url.href })),
            t.location.assign &&
      ...
      3498: function (e, t, r) {
        r.r(t), r.d(t, { nativeFunction: () => n, nativeGetOwnPropertyDescriptor: () => s });
        let n = self.Function,
            ...
            e.Proxy('Cache.prototype.addAll', {
              apply(t) {
                for (let r = 0; r < t.args[0].length; r++)
                  ('string' == typeof t.args[0][r] || t.args[0][r] instanceof URL) &&
      ...
      5146: function (e, t, r) {
        r.r(t), r.d(t, { argdbg: () => i, default: () => a, enabled: () => s });
        var n = r(7097);
      ...
      7651: function (e, t, r) {
        r.r(t), r.d(t, { default: () => a, enabled: () => i });
        var n = r(7097),
          s = r(2434);
      ...
      4423: function (e, t, r) {
        r.r(t), r.d(t, { default: () => i, indirectEval: () => a });
        var n = r(7097),
          s = r(4079);
        function i(e, t) {
		...
		`)))
                : (r = this.global.eval),
              r((0, s.Z)(t, '(indirect eval proxy)', this.meta)));
        }
      },
      8231: function (e, t, r) {
        ...
        function l(e, t) {
          ...
          function l(e) {
            return new Proxy(e, {
              apply(e, n, s) {
                    ...
                    s[0] = new Proxy(a, {
                      get(e, r, n) {
                        ...
                        return r in t
                          ...
                          ? new Proxy(s, {
                              apply: (e, t, r) =>
                                t === n ? Reflect.apply(e, a, r) : Reflect.apply(e, t, r),
                            })
                          : s;
                      },
                ...
                return (
                  t.event ||
                    Object.defineProperty(t, 'event', { get: () => s[0], configurable: !0 }),
                  Reflect.apply(e, n, s)
                );
              },
              getOwnPropertyDescriptor: i.getOwnPropertyDescriptorHandler,
          ...
          e.Proxy('EventTarget.prototype.addEventListener', {
            apply(t) {
              ...
              (s ||= []).push({ event: t.args[0], originalCallback: r, proxiedCallback: n }),
            ...
            e.Proxy('EventTarget.prototype.removeEventListener', {
              apply(t) {
                ...
                if (!r) return;
                let n = r.findIndex(
                  (e) => e.event === t.args[0] && e.originalCallback === t.args[1],
                );
                if (-1 === n) return;
                let s = r.splice(n, 1);
          ...
          for (let s of (n.iswindow && c.push(t.HTMLElement.prototype),
          t.Worker && c.push(t.Worker.prototype),
          c))
      ...
      4636: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          (t[n.vc.globals.importfn] = function (t, n) {
            ...
            return n.includes(':') || n.startsWith('/') || n.startsWith('.') || n.startsWith('..')
              ? r(`return import("${(0, s.dm)(i, e.meta)}?type=module")`)()
              : r(`return import("${n}")`)();
          }),
            ...
            apply(t) {
              ...
              t.return(
                (async () => {
                  ...
                  return Object.defineProperty(n, 'name', { value: '', writable: !1 }), n;
                })(),
              );
            },
          });
      ...
      2625: function (e, t, r) {
        ...
        function a(e) {
          ...
          self.Worker && t.push('Worker.prototype.postMessage'),
            ...
            e.Proxy(t, {
              apply(e) {
                e.args[0] = { $scramjet$messagetype: 'worker', $scramjet$data: e.args[0] };
              },
            });
        }
      },
      ...
      106: function (e, t, r) {
        ...
        function i(e) {
          e.Proxy('fetch', {
            apply(t) {
              ('string' == typeof t.args[0] || t.args[0] instanceof URL) &&
                ((t.args[0] = (0, s.dm)(t.args[0], e.meta)),
            ...
            e.Trap('Response.prototype.url', { get: (e) => (0, s.Sd)(e.get()) }),
            e.Trap('Request.prototype.url', { get: (e) => (0, s.Sd)(e.get()) });
        }
      },
      7219: function (e, t, r) {
        function n(e, t) {
          ...
          e.Proxy('WebSocket', {
            construct(n) {
              ...
              function o(e) {
                a['on' + e.type]?.(
                  new Proxy(e, { get: (e, t) => 'isTrusted' === t || Reflect.get(e, t) }),
                ),
                  s.dispatchEvent(e);
              }
                ...
                i.addEventListener('message', async (e) => {
                  ...
                  'string' == typeof t ||
                    ('byteLength' in t
                      ...
                      : 'arrayBuffer' in t &&
                        'arraybuffer' === a.binaryType &&
                        Object.setPrototypeOf((t = await t.arrayBuffer()), ArrayBuffer.prototype)),
                    o(
            ...
            e.Trap('WebSocket.prototype.extensions', { get: (e) => r.get(e.this).extensions }),
            ...
            e.Trap('WebSocket.prototype.url', { get: (e) => r.get(e.this).url }),
            e.Trap('WebSocket.prototype.protocol', { get: (e) => r.get(e.this).protocol }),
            ...
            e.Trap('WebSocketStream.prototype.closed', { get: (e) => n.get(e.this).closed }),
            e.Trap('WebSocketStream.prototype.opened', { get: (e) => n.get(e.this).opened }),
            e.Trap('WebSocketStream.prototype.url', { get: (e) => n.get(e.this).url }),
            e.Proxy('WebSocketStream.prototype.close', {
              apply(e) {
                let t = n.get(e.this);
                return e.args[0]
                  ? (void 0 === e.args[0].closeCode && (e.args[0].closeCode = 1e3),
                    void 0 === e.args[0].reason && (e.args[0].reason = ''),
                    e.return(t.barews.close(e.args[0].closeCode, e.args[0].reason)))
      ...
      7481: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          e.Proxy('XMLHttpRequest.prototype.open', {
            apply(t) {
              t.args[1] && (t.args[1] = (0, s.dm)(t.args[1], e.meta)),
            ...
            e.Proxy('XMLHttpRequest.prototype.send', {
              apply(t) {
                ...
                if (!(0, n.Sp)('syncxhr', e.url))
                  return (
                    console.warn('ignoring request - sync xhr disabled in flags'), t.return(void 0)
                  );
                let o = new SharedArrayBuffer(1024, { maxByteLength: 0x7fffffff }),
                  l = new DataView(o);
                ...
                e.RawTrap(t.this, 'status', { get: () => u }),
                  ...
                  e.RawTrap(t.this, 'getAllResponseHeaders', { get: () => () => p }),
            ...
            e.Trap('XMLHttpRequest.prototype.responseURL', { get: (e) => (0, s.Sd)(e.get()) });
        }
      },
      6321: function (e, t, r) {
        r.r(t), r.d(t, { default: () => o, enabled: () => a });
        var n = r(7097),
          s = r(9777),
          i = r(1762).Z;
            ...
            value: (t, r) => {
              ...
              !(function (e, t) {
                ...
                for (let e = 0; e < o; e++) {
                  ...
                  l += 4;
                  let s = n.getUint8(l);
                  if (((l += 1), 0 == s)) a.push({ type: s, start: e, size: t });
                  else if (1 == s) {
                    let o = e + t,
                      c = n.getUint32(l, !0);
                    l += 4;
                    let u = i.decode(r.subarray(l, l + c));
                    a.push({ type: s, start: e, end: o, str: u });
                  }
                }
                    ...
                    let [n, i, a] = r,
                      ...
                      c = (function (e) {
                        function t(r) {
                          ...
                          if (r[n] && r[n].sourcemaps && r[n].sourcemaps[e])
                            return r[n].sourcemaps[e];
      ...
      8475: function (e, t, r) {
        ...
        function i(e, t) {
          e.Proxy('Worker', {
            construct(t) {
              (t.args[0] = (0, s.dm)(t.args[0], e.meta) + '?dest=worker'),
            ...
            e.Proxy('SharedWorker', {
              construct(t) {
                (t.args[0] = (0, s.dm)(t.args[0], e.meta) + '?dest=sharedworker'),
                  t.args[1] &&
                    'string' == typeof t.args[1] &&
                    (t.args[1] = `${e.url.origin}@${t.args[1]}`),
                  t.args[1] &&
                    'object' == typeof t.args[1] &&
                    ('module' === t.args[1].type && (t.args[0] += '&type=module'),
      ...
      7706: function (e, t, r) {
        r.r(t), r.d(t, { createWrapFn: () => o, default: () => c, order: () => l });
        var n = r(2534),
          s = r(9777),
          i = r(7097),
          a = r(4423);
        ...
        function c(e, t) {
          Object.defineProperty(t, i.vc.globals.wrapfn, {
            ...
            Object.defineProperty(t, i.vc.globals.wrappropertyfn, {
              value: function (e) {
                return 'location' === e || 'parent' === e || 'top' === e || 'eval' === e
                  ? i.vc.globals.wrappropertybase + e
                  : e;
              },
              writable: !1,
              configurable: !1,
            ...
            Object.defineProperty(t, i.vc.globals.cleanrestfn, {
              value: function (e) {},
              writable: !1,
              configurable: !1,
              enumerable: !1,
            }),
            Object.defineProperty(t.Object.prototype, i.vc.globals.wrappropertybase + 'location', {
              get: function () {
            ...
            (t.$scramitize = function (e) {
              return (
                location,
                n.iswindow && (t.parent, t.document, t.top),
        ...
        function a(e, t) {
          ...
          if ('fetch' === i) {
            ...
            for (let o of i) {
              ...
              Object.defineProperty(l, 'destination', { value: i.destinitation });
              ...
              (c.respondWith = (e) => {
                ...
                s.log('to fn', c),
                o.proxiedCallback(
                  new Proxy(c, { get: (e, t, r) => 'isTrusted' === t || Reflect.get(e, t) }),
                ),
                u ||
      ...
      4043: function (e, t, r) {
        r.r(t), r.d(t, { ScramjetController: () => o });
        var n = r(7097),
          s = r(129),
          i = r(5008),
          a = r(1762).Z;
        class o extends EventTarget {
            ...
            (0, n.t8)(),
              ...
              navigator.serviceWorker.addEventListener('message', (e) => {
                ...
                'download' === t.scramjet$type &&
                  this.dispatchEvent(new i.ScramjetGlobalDownloadEvent(t.download));
              });
          }
          createFrame(e) {
          ...
          encodeUrl(e) {
            if (
              ...
              return e.href;
            let t = (0, n.yf)(e.hash.slice(1));
            return (e.hash = ''), n.vc.prefix + (0, n.yf)(e.href) + (t ? '#' + t : '');
          }
          decodeUrl(e) {
            e instanceof URL && (e = e.toString());
          ...
          async openIDB() {
            ...
            return new Promise((t, r) => {
              (e.onsuccess = async () => {
                ...
                (e.onupgradeneeded = () => {
                  let t = e.result;
                  t.objectStoreNames.contains('config') || t.createObjectStore('config'),
  ...
  `,
            ...
            time(e, t, r) {
              ...
              (s = i < 1 ? 'BLAZINGLY FAST' : i < 500 ? 'decent speed' : 'really slow'),
                this.print('debug', '[time]', `${r} was ${s} (${i.toFixed(2)}ms)`);
            },
          };
      },
      9734: function (e, t, r) {
          ...
          getCookies(e, t) {
            ...
            for (let i of n) {
              ...
              (!i.secure || 'https:' === e.protocol) &&
                ...
                (!i.domain.startsWith('.') || e.hostname.endsWith(i.domain.slice(1))) &&
                s.push(i);
            }
      ...
      302: function (e, t, r) {
        ...
        let a = [
          ...
          { fn: (e, t) => (0, s.q5)(e, t), srcset: ['img', 'source'], imagesrcset: ['link'] },
          {
            fn: (e, t, r) =>
              (0, s.r4)(
                e,
                r,
                { origin: new URL(t.origin.origin), base: new URL(t.origin.origin) },
                !0,
              ),
            srcdoc: ['iframe'],
          },
          { fn: (e, t) => (0, n.U)(e, t), style: '*' },
          {
            fn: (e, t) =>
      ...
      7097: function (e, t, r) {
        let n, s, i;
        r.d(t, { Sp: () => l, _h: () => s, t8: () => o, v6: () => c, vc: () => i, yf: () => n });
        let a = Function;
        function o() {
      ...
      5701: function (e, t, r) {
        ...
        function a(e, t, r) {
          return (t = (t = (t = new String(t).toString()).replace(
            /url\(['"]?(.+?)['"]?\)/gm,
            (t, s) => {
        ...
        async function l(e, t, r, l) {
          ...
          if (
            ('string' == typeof c.link
              ? (c.link = o(c.link, t))
              : Array.isArray(c.link) && (c.link = c.link.map((e) => o(e, t))),
          ...
          return (
            ...
            'string' == typeof c['sec-fetch-site'] &&
              ...
              ('string' == typeof c.referer
                ? (c['sec-fetch-site'] = await (0, s.$L)(t, new URL(c.referer), r))
                : (console.warn(
	...
	`,
            ...
            m = (function (e, t, r, c = !1) {
              ...
              if (
                ...
                (function e(t, r, n) {
                  if (
                    ...
                    for (let e of u.G)
                      for (let s in e) {
                        ...
                        if (
                          ...
                          let i = t.attribs[s],
                            a = e.fn(i, n, r);
                          null === a ? delete t.attribs[s] : (t.attribs[s] = a),
                    ...
                    for (let [e, r] of Object.entries(t.attribs))
                      b.includes(e) &&
                        ...
                        (t.attribs[e] = (0, l.Z)(r, `(inline ${e} on element)`, n)));
                  }
                  if (
                    ('style' === t.name &&
                      void 0 !== t.children[0] &&
                      (t.children[0].data = (0, o.U)(t.children[0].data, n)),
                    'script' === t.name &&
                  ...
                  if (
                    'script' === t.name &&
                    /(application|text)\/javascript|module|undefined/.test(t.attribs.type) &&
                    void 0 !== t.children[0]
                  ) {
                    let e = t.children[0].data,
                ...
                e || ((e = new s.W_('head', {}, [])), d.root.children.unshift(e)),
                  e.children.unshift(...h(t, (e) => new s.W_('script', { src: e })));
              }
              return (0, i.Z)(d.root, { encodeEntities: 'utf8', decodeEntities: !1 });
            })(e, t, r, c);
              ...
              if ('attribs' in t)
                for (let e in t.attribs) {
                  ...
                  e.startsWith('scramjet-attr-') &&
                    ((t.attribs[e.slice(14)] = t.attribs[e]), delete t.attribs[e]);
                }
              if ('childNodes' in t) for (let r of t.childNodes) e(r);
            })(t.root),
            (0, i.Z)(t.root, { decodeEntities: !1 })
          );
        }
        function m(e, t) {
          return e
          ...
          return (function (e, t, r, a) {
            ...
            try {
              ...
              try {
                l =
                  'string' == typeof e
                    ? o.rewrite_js(e, r.base.href, t || '(unknown)', a)
                    : o.rewrite_js_bytes(e, r.base.href, t || '(unknown)', a);
              } catch (r) {
                return (
                  console.warn(
                    ...
                    t,
                    r.message,
                    e instanceof Uint8Array ? s.zN.decode(e) : e,
                  ),
                  { js: e, tag: '', map: null }
                );
              }
              i.time(r, c, `oxc rewrite for "${t || '(unknown)'}"`);
              let { js: u, map: d, scramtag: h, errors: p } = l;
              if (
                ((0, n.Sp)('sourcemaps', r.base) &&
                  !globalThis.clients &&
                  (globalThis[n.vc.globals.pushsourcemapfn](Array.from(d), h), (d = null)),
                (0, n.Sp)('rewriterLogs', r.base))
              )
                for (let e of p) console.error('oxc parse error', e);
              return { js: 'string' == typeof e ? s.zN.decode(u) : u, tag: h, map: d };
            } finally {
              l();
            }
          })(e, t, r, o);
      ...
      2434: function (e, t, r) {
        ...
        function l(e, t) {
          if ((e instanceof URL && (e = e.toString()), e.startsWith('javascript:')))
            return 'javascript:' + (0, s.Z)(e.slice(11), '(javascript: url)', t);
          {
            if (e.startsWith('blob:') || e.startsWith('data:'))
              return location.origin + n.vc.prefix + e;
            ...
            return (
              (s.hash = ''), location.origin + n.vc.prefix + (0, n.yf)(s.href) + (a ? '#' + a : '')
            );
          }
        }
        function c(e) {
      ...
      522: function (e, t, r) {
        ...
        function g(e) {
          ...
          (0, s.rb)({ module: new WebAssembly.Module(n) });
          let r = f.findIndex((e) => !e.inUse),
            d = f.length;
          return (
            -1 === r
              ? ((0, i.Sp)('rewriterLogs', e.base) &&
                  console.log(`creating new rewriter, ${d} rewriters made already`),
                (t = {
                  rewriter: new s.mZ({
                    config: i.vc,
                    shared: {
                    ...
                    flagEnabled: i.Sp,
                    codec: { encode: i.yf, decode: i._h },
                  }),
                  inUse: !1,
                }),
                f.push(t))
              : ((0, i.Sp)('rewriterLogs', e.base) &&
                  console.log(`using cached rewriter ${r} from list of ${d} rewriters`),
                (t = f[r])),
            (t.inUse = !0),
      ...
      7846: function (e, t, r) {
        ...
        function i(e, t, r, i) {
          let a = '',
            ...
            l = (e) => {
              o
                ? (a += `import "${n.vc.files[e]}"
`)
                : (a += `importScripts("${n.vc.files[e]}");
`);
            };
          l('wasm'), l('all'), (a += `$scramjetLoadClient().loadAndHook(${JSON.stringify(n.vc)});`);
          let c = (0, s.Z)(e, r, i, o);
          return c instanceof Uint8Array && (c = new TextDecoder().decode(c)), (a += c);
        }
      },
      9739: function (e, t, r) {
        r.d(t, { JN: () => u, N0: () => h, TE: () => c, UX: () => d, W_: () => l, Wq: () => p });
        ...
        async function u(e, t) {
          ...
          return (n[t] ?? 0) > s
            ? ((r.mostRestrictiveSite = t), await a(e, r), t)
      ...
      4155: function (e, t, r) {
        ...
        function n(e, t) {
          ...
          return (
            crossOriginIsolated && (r['Cross-Origin-Embedder-Policy'] = 'require-corp'),
            new Response(
              (function (e, t) {
                let r = `
...
self.WASM = '${r}';`),
                  new Response(n, { headers: { 'content-type': 'text/javascript' } })
                );
              });
            let u = '',
              d = {};
            ...
            if (
              ...
              let t,
                r = o.pathname.substring(this.config.prefix.length);
              ...
              return (
                ...
                new Response(t, { status: n.status, statusText: n.statusText, headers: s })
              );
            }
            ...
            v
              ? (m.set('Sec-Fetch-Dest', 'document'), m.set('Sec-Fetch-Mode', 'navigate'))
            ...
            if (
              ...
              '' !== e.referrer &&
              'no-referrer' !== e.referrer &&
              e.referrer.includes(c.vc.prefix)
            ) {
            ...
            await (0, i.W_)(h.toString(), e.referrer ? (0, a.Sd)(e.referrer) : null, x),
              m.set('Sec-Fetch-Site', await (0, i.JN)(h.toString(), x));
            ...
            let t = { message: s.message, url: e.url, destination: e.destination };
            if (
        ...
        async function y(e, t, r, n, o, l, d, h, p, f, m) {
          let y,
            S = 'navigate' === o && ['document', 'iframe'].includes(n),
            v = await (0, u.V)(l.rawHeaders, t, p, { get: i.Wq, set: i.N0 });
          if (
            (S && v['referrer-policy'] && m && (await (0, i.N0)(e.href, v['referrer-policy'], m)),
            g(l))
          ) {
            let t = new URL((0, a.Sd)(v.location));
            await (0, i.TE)(e.toString(), t.toString(), v['referrer-policy']);
            let n = await (0, s.$L)({ origin: t, base: t }, e, p);
            if ((await (0, i.JN)(t.toString(), n), r)) {
              let e = new URL(v.location);
              e.searchParams.set('type', r), (v.location = e.href);
            }
          }
          let x = v['set-cookie'] || [];
          for (let t in x)
            if (h) {
              let r = f.dispatch(h, { scramjet$type: 'cookie', cookie: t, url: e.href });
              'document' !== n && 'iframe' !== n && (await r);
            }
          for (let t in (await d.setCookies(x instanceof Array ? x : [x], e), v))
          ...
          if (
            ...
            if ((0, c.Sp)('interceptDownloads', e)) {
              ...
              let n = v['content-length'],
                s = await clients.matchAll({ type: 'window' });
              if ((s = s.filter((e) => !e.url.includes(c.vc.prefix))).length < 1)
              ...
              s[0].postMessage({ scramjet$type: 'download', download: i }, [l.body]),
                await new Promise(() => {});
            } else {
          ...
          switch (r) {
            ...
            case 'document':
              if (e.headers.get('content-type')?.startsWith('text/html'))
                return (0, d.r4)(await e.text(), s, t, !0);
              return e.body;
            case 'script': {
              let {
                js: r,
...
${r}`;
      ...
      7735: function (e, t, r) {
        r.r(t), r.d(t, { ScramjetServiceWorker: () => c });
        var n = r(9022),
          s = r(8931),
          i = r(9680),
          a = r(522),
              ...
              addEventListener('message', async ({ data: t }) => {
                if ('scramjet$type' in t) {
                  ...
                  if ('registerServiceWorker' === t.scramjet$type)
                    return void this.serviceWorkers.push(new n.Y(t.port, t.origin));
                  'cookie' === t.scramjet$type &&
                    ...
                    'loadConfig' === t.scramjet$type && (this.config = t.config);
                }
              });
          }
          async dispatch(e, t) {
      ...
      9680: function (e, t, r) {
        ...
        async function c() {
          let e = Promise.race([
            Promise.any(
              (await self.clients.matchAll({ type: 'window', includeUncontrolled: !0 })).map(
                async (e) => {
                  let t,
        ...
        class p {
          ...
          async sendMessage(e, t) {
            ...
            return o.call(this.port, { message: e, port: r.port2 }, n), await s;
          }
        }
          ...
          async setRemoteTransport(e, t) {
            ...
            (r.port1.onmessage = async (t) => {
                  ...
                  e.ready || (await e.init()),
                    await (async function (e, t, r) {
                      ...
                      n.body instanceof ReadableStream || n.body instanceof ArrayBuffer
                        ? o.call(t, { type: 'fetch', fetch: n }, [n.body])
                        : o.call(t, { type: 'fetch', fetch: n });
                    })(n, r, e);
                } catch (e) {
                  g(r, e, 'fetch');
                }
                  ...
                  e.ready || (await e.init()),
                    await (async function (e, t, r) {
                      ...
                      (e.websocket.channel.onmessage = (e) => {
                        'data' === e.data.type
                          ? n(e.data.data)
                          : 'close' === e.data.type && s(e.data.closeCode, e.data.closeReason);
                      }),
              ...
              await this.worker.sendMessage(
                { type: 'set', client: { function: 'bare-mux-remote', args: [r.port2, t] } },
                [r.port2],
              );
          }
          getInnerPort() {
                ...
                switch (t.type) {
                  ...
                  case n.Vp:
                    return (function (t, r) {
                      var n;
                      'foreign' === r.xmlMode &&
                        ((t.name = null != (n = i.r.get(t.name)) ? n : t.name),
                        t.parent && u.has(t.parent.name) && (r = { ...r, xmlMode: !1 })),
                        !r.xmlMode && d.has(t.name) && (r = { ...r, xmlMode: 'foreign' });
                      let a = `<${t.name}`,
                        c = (function (e, t) {
                          var r;
                          if (!e) return;
                          let n =
                            (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1
                              ? o
                      ...
                      return (
                        c && (a += ` ${c}`),
                        0 === t.children.length &&
                        (r.xmlMode ? !1 !== r.selfClosingTags : r.selfClosingTags && l.has(t.name))
                          ? (r.xmlMode || (a += ' '), (a += '/>'))
                          : ((a += '>'),
                            t.children.length > 0 && (a += e(t.children, r)),
                            (r.xmlMode || !l.has(t.name)) && (a += `</${t.name}>`)),
                        a
                      );
                    })(t, r);
                  case n.xv:
                    return (function (e, t) {
                      ...
                      return (
                        (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1 ||
                          ...
                          (n =
                            t.xmlMode || 'utf8' !== t.encodeEntities ? (0, s.RU)(n) : (0, s.bk)(n)),
                        n
                      );
                    })(t, r);
                }
      ...
      835: function (e, t, r) {
        r.d(t, { BB: () => d, Pq: () => u, W_: () => h, sv: () => o, v8: () => l, xv: () => a });
        var n = r(7699);
        class s {
          constructor() {
            (this.parent = null),
        ...
        class h extends c {
          constructor(
            ...
            t,
            r = [],
            s = 'script' === e ? n.Hd.Script : 'style' === e ? n.Hd.Style : n.Hd.Tag,
          ) {
        ...
        function p(e, t = !1) {
          ...
          if (e.type === n.Hd.Text) r = new a(e.data);
            ...
            n.forEach((e) => (e.parent = s)),
              ...
              e['x-attribsNamespace'] && (s['x-attribsNamespace'] = { ...e['x-attribsNamespace'] }),
      ...
      812: function (e, t, r) {
        r.d(t, { HP: () => d.H, PQ: () => g, SX: () => u, bg: () => p.bg, mP: () => h.m });
        var n,
          s,
          i,
          a,
        ...
        class g {
          ...
          addToNumericResult(e, t, r, n) {
            if (t !== r) {
              let s = r - t;
              (this.result = this.result * Math.pow(n, s) + Number.parseInt(e.substr(t, s), n)),
                (this.consumed += s);
            }
          }
          stateNumericHex(e, t) {
            ...
            for (; t < e.length; ) {
              ...
              if (
                !f(s) &&
                (!((n = s) >= o.UPPER_A) || !(n <= o.UPPER_F)) &&
                (!(n >= o.LOWER_A) || !(n <= o.LOWER_F))
              )
                return this.addToNumericResult(e, r, t, 16), this.emitNumericEntity(s, 3);
              t += 1;
            }
          ...
          emitNumericEntity(e, t) {
            ...
            return (
              this.emitCodePoint((0, p.tL)(this.result), this.consumed),
              this.errors &&
        ...
        function a(e) {
          ...
          for (; null !== (t = n.exec(e)); ) {
            let { index: o } = t,
              ...
              c = s.get(l);
            void 0 === c
              ? ((r += `${e.substring(a, o)}&#x${i(e, o).toString(16)};`),
                (a = n.lastIndex += Number((64512 & l) == 55296)))
      ...
      3906: function () {},
      7918: function (e, t, r) {
        r.d(t, { RU: () => o.RU, bk: () => o.bk, kb: () => o.kb }), r(812), r(4511);
        var n,
          s,
          i,
          a,
        ...
        class g {
          constructor(e, t = {}) {
            ...
            (this.options = t),
              ...
              (this.tokenizer = new (null != (a = t.Tokenizer) ? a : n.Z)(this.options, this)),
          ...
          ontextentity(e, t) {
            var r, n;
            (this.endIndex = t - 1),
              null == (n = (r = this.cbs).ontext) || n.call(r, (0, s.bg)(e)),
              (this.startIndex = t);
          }
          isVoidElement(e) {
          ...
          endOpenTag(e) {
            ...
            (this.startIndex = this.openTagStart),
              this.attribs &&
                (null == (r = (t = this.cbs).onopentag) || r.call(t, this.tagname, this.attribs, e),
                (this.attribs = null)),
              this.cbs.onclosetag &&
          ...
          onclosetag(e, t) {
            ...
            if (
              ...
              this.htmlMode &&
                ...
                null == (o = (a = this.cbs).onopentag) || o.call(a, 'br', {}, !0),
          ...
          closeCurrentTag(e) {
            ...
            this.endOpenTag(e),
              this.stack[0] === n &&
                (null == (r = (t = this.cbs).onclosetag) || r.call(t, n, !e), this.stack.shift());
          }
          onattribname(e, t) {
            this.startIndex = e;
            let r = this.getSlice(e, t);
          ...
          oncomment(e, t, r) {
            var n, s, i, a;
            (this.endIndex = t),
              null == (s = (n = this.cbs).oncomment) || s.call(n, this.getSlice(e, t - r)),
              null == (a = (i = this.cbs).oncommentend) || a.call(i),
              (this.startIndex = t + 1);
          }
          oncdata(e, t, r) {
            ...
            !this.htmlMode || this.options.recognizeCDATA
              ? (null == (s = (n = this.cbs).oncdatastart) || s.call(n),
                null == (a = (i = this.cbs).ontext) || a.call(i, p),
                null == (l = (o = this.cbs).oncdataend) || l.call(o))
              : (null == (u = (c = this.cbs).oncomment) || u.call(c, `[CDATA[${p}]]`),
        ...
        class p {
          constructor({ xmlMode: e = !1, decodeEntities: t = !0 }, r) {
            (this.cbs = r),
              ...
              (this.entityDecoder = new c.PQ(e ? c.mP : c.HP, (e, t) => this.emitCodePoint(e, t)));
          }
          reset() {
            (this.state = o.Text),
              (this.buffer = ''),
          ...
          stateInSpecialTag(e) {
            ...
            (32 | e) === this.currentSequence[this.sequenceIndex]
              ...
              ? this.currentSequence === h.TitleEnd
                ? this.decodeEntities && e === a.Amp && this.startEntity()
                : this.fastForwardTo(a.Lt) && (this.sequenceIndex = 1)
              : (this.sequenceIndex = Number(e === a.Lt));
          }
          stateCDATASequence(e) {
            e === h.Cdata[this.sequenceIndex]
              ? ++this.sequenceIndex === h.Cdata.length &&
                ((this.state = o.InCommentLike),
          ...
          isTagStartChar(e) {
            return this.xmlMode
              ? !d(e)
              : (e >= a.LowerA && e <= a.LowerZ) || (e >= a.UpperA && e <= a.UpperZ);
          }
          startSpecial(e, t) {
            (this.isSpecial = !0),
            ...
            if (e === a.ExclamationMark)
              ...
              (this.sectionStart = this.index),
                this.xmlMode
                  ...
                  : t === h.ScriptEnd[2]
                  ? (this.state = o.BeforeSpecialS)
                  : t === h.TitleEnd[2] || t === h.XmpEnd[2]
                  ? (this.state = o.BeforeSpecialT)
                  : (this.state = o.InTagName);
            } else
              e === a.Slash
                ? (this.state = o.BeforeClosingTagName)
                : ((this.state = o.Text), this.stateText(e));
          }
          stateInTagName(e) {
            d(e) &&
          ...
          stateBeforeClosingTagName(e) {
            u(e) ||
              (e === a.Gt
                ? (this.state = o.Text)
                : ((this.state = this.isTagStartChar(e) ? o.InClosingTagName : o.InSpecialComment),
                  (this.sectionStart = this.index)));
          }
          ...
          stateAfterClosingTagName(e) {
            (e === a.Gt || this.fastForwardTo(a.Gt)) &&
              ((this.state = o.Text), (this.sectionStart = this.index + 1));
          }
          stateBeforeAttributeName(e) {
            e === a.Gt
              ? (this.cbs.onopentagend(this.index),
                this.isSpecial
                  ? ((this.state = o.InSpecialTag), (this.sequenceIndex = 0))
                  : (this.state = o.Text),
                (this.sectionStart = this.index + 1))
              : e === a.Slash
              ? (this.state = o.InSelfClosingTag)
              : u(e) || ((this.state = o.InAttributeName), (this.sectionStart = this.index));
          }
          stateInSelfClosingTag(e) {
            e === a.Gt
              ? (this.cbs.onselfclosingtag(this.index),
                ...
                (this.sectionStart = this.index + 1),
                (this.isSpecial = !1))
              : u(e) || ((this.state = o.BeforeAttributeName), this.stateBeforeAttributeName(e));
          }
          ...
          stateAfterAttributeName(e) {
            e === a.Eq
              ? (this.state = o.BeforeAttributeValue)
              : e === a.Slash || e === a.Gt
          ...
          stateBeforeAttributeValue(e) {
            e === a.DoubleQuote
              ? ((this.state = o.InAttributeValueDq), (this.sectionStart = this.index + 1))
              : e === a.SingleQuote
              ? ((this.state = o.InAttributeValueSq), (this.sectionStart = this.index + 1))
              : u(e) ||
                ((this.sectionStart = this.index),
          ...
          handleInAttributeValue(e, t) {
            e === t || (!this.decodeEntities && this.fastForwardTo(t))
              ? (this.cbs.onattribdata(this.sectionStart, this.index),
                (this.sectionStart = -1),
                this.cbs.onattribend(t === a.DoubleQuote ? l.Double : l.Single, this.index + 1),
                (this.state = o.BeforeAttributeName))
              : this.decodeEntities && e === a.Amp && this.startEntity();
          }
          ...
          stateBeforeDeclaration(e) {
            e === a.OpeningSquareBracket
              ? ((this.state = o.CDATASequence), (this.sequenceIndex = 0))
              : (this.state = e === a.Dash ? o.BeforeComment : o.InDeclaration);
          }
          ...
          startEntity() {
            (this.baseState = this.state),
              ...
              this.entityDecoder.startEntity(
                this.xmlMode
                  ? c.SX.Strict
                  : this.baseState === o.Text || this.baseState === o.InSpecialTag
                  ? c.SX.Legacy
                  : c.SX.Attribute,
              );
          }
          stateInEntity() {
            ...
            e >= 0
              ? ((this.state = this.baseState), 0 === e && (this.index = this.entityStart))
              : (this.index = this.offset + this.buffer.length - 1);
          }
          cleanup() {
            this.running &&
              this.sectionStart !== this.index &&
              (this.state === o.Text || (this.state === o.InSpecialTag && 0 === this.sequenceIndex)
                ? (this.cbs.ontext(this.sectionStart, this.index), (this.sectionStart = this.index))
                : (this.state === o.InAttributeValueDq ||
                    this.state === o.InAttributeValueSq ||
                    this.state === o.InAttributeValueNq) &&
                  (this.cbs.onattribdata(this.sectionStart, this.index),
                  (this.sectionStart = this.index)));
          }
          ...
          finish() {
            this.state === o.InEntity && (this.entityDecoder.end(), (this.state = this.baseState)),
  ...
  (r.n = (e) => {
    ...
    (self.$scramjetVersion = { build: '8a4a72f', version: '1.0.2-dev' }),
